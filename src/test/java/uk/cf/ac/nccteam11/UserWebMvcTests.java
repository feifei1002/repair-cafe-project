...
//    @WithUserDetails
    public void shouldBeAbleToCreateANewAccount() throws Exception{
        //GIVEN
        UserDTO newUser = new UserDTO(1, "Fei", "Liu", "email123@gmail.com","0123456789", "P@55w0rd", "Tyndall Street",  "Cardiff", "CF10 4BZ", "ROLE_USER", 1);
        ...
        //THEN
        mvc.perform(post("/sign-up")).andExpect(status().is2xxSuccessful());
    }
}
